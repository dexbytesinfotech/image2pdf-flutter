...
class _CameraExampleHomeState extends State<CameraExampleHome>
          ...
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                color: Configuration.instance!.cameraBgColor,
                border: Border.all(
                  color:
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: Text("Please wait preparing camera")),
                            ],
                          ),
                        )
                      : SizedBox()
  ...
  Widget _thumbnailWidget() {
    return Align(
      alignment: (imageFileList == null || imageFileList!.isEmpty)
                    ...
                    InkWell(
                      ...
                      child: SizedBox(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Configuration.instance!.importImgIcon,
                              Text(
                                "Import",
                                style: Configuration.instance!.importTextStyle,
                              ),
                            ],
                          )),
                    ),
                  ...
                  SizedBox(
                      ...
                      child:
                        ...
                        children: [
                          kIsWeb
                              ? Image.network(
                                  imageFileList![imageFileList!.length - 1])
                              : Image.file(File(
                                  imageFileList![imageFileList!.length - 1])),
                          Align(
                            alignment: Alignment.topRight,
                            child: fileCount(imageFileList!.length),
                          )
                        ],
                      )),
    ...
    return Column(
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            IconButton(
              icon: Icon(Icons.flash_on, color: iconColors),
              color: Colors.blue,
            ...
            ...!kIsWeb
                ? <Widget>[
                    IconButton(
                      icon: Icon(Icons.exposure, color: iconColors),
                      color: Colors.blue,
                    ...
                    IconButton(
                      icon: Icon(Icons.filter_center_focus, color: iconColors),
                      color: Colors.blue,
                      onPressed:
  ...
  Widget _exposureModeControlRowWidget() {
    final ButtonStyle styleAuto = TextButton.styleFrom(
      /// TODO(predestination): Migrate to new API once it lands in stable: https://github.com/flutter/flutter/issues/105724
  ...
  Widget cameraButton(GestureTapCallback onTap) {
    return Container(
      // color: Colors.blue,
      child: InkWell(
        onTap: onTap,
        child: Configuration.instance!.takeImgIcon,
      ),
    );
  }
              ...
              child: SizedBox(
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [Configuration.instance!.closeCameraIcon],
                    ),
                  ))),
          Expanded(
              flex: 5,
...
/*        try {
        ...
        setState(() {
          if (documentUniqueId.isEmpty) {
            DateTime now = DateTime.now();
            documentUniqueId = "${now.millisecondsSinceEpoch}";
            try {
              documentSavedTime = DateFormat('dd/MM/yy hh:mm:ss').format(now);
            } catch (e) {
              documentSavedTime = now.millisecondsSinceEpoch.toString();
              print(e);
            }
          ...
          json['document_name'] = "$documentUniqueName";
          json['document_save_date_and_time'] = "$documentSavedTime";
          json['document_save_id'] = "$documentUniqueId";
          json['document_image_path_list'] = imageFileList;

          setDocument = DocumentPathModel(
              documentName: documentUniqueName,
              documentSaveId: "$documentUniqueId",
              documentImagePathList: imageFileList!,
